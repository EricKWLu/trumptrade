...
```
Task(
  prompt="Read C:/Users/ericl/Projects/trump_trade/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/ericl/Projects/trump_trade/.claude/get-shit-done/templates/VALIDATION.md`
