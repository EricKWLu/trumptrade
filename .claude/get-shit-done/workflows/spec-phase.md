...
```bash
INIT=$(node "C:/Users/ericl/Projects/trump_trade/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/ericl/Projects/trump_trade/.claude/get-shit-done/templates/spec.md.
